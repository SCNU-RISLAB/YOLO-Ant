...
def run(
    ...
    if not training:
        ...
        dataloader = create_dataloader(data[task],
                                       ...
                                       pad=pad,
                                       #rect=rect,
                                       rect=False,#使用transformer需要关掉rect
                                       workers=workers,
...
def parse_opt():
    ...
    parser.add_argument('--project', default=ROOT / 'runs/val/final', help='save to project/name')
    parser.add_argument('--name', default='v5s_vis', help='save to project/name')
    parser.add_argument('--exist-ok', action='store_true', help='existing project/name ok, do not increment')
    parser.add_argument('--half', action='store_true', help='use FP16 half-precision inference') #,default=False)
