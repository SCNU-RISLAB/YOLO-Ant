...
from models.dslkblock import DSLK
from models.dslkvit import DSLKVit1,DSLKVit2
...
class Conv(nn.Module):
    ...
    #def __init__(self, c1, c2, k=1, s=1, p=None, g=1, d=1, act=True):
        super().__init__()   #多继承需用到super函数，这是对继承自父类的属性进行初始化,可用于调用父类方法，python2中则是super(Conv,self)
